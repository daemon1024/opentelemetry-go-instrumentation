...
type bpfProgramSpecs struct {
	UprobeIter        *ebpf.ProgramSpec `ebpf:"uprobe_Iter"`
	UprobeIterReturns *ebpf.ProgramSpec `ebpf:"uprobe_Iter_Returns"`
}
...
type bpfMapSpecs struct {
	...
	CqlEvents             *ebpf.MapSpec `ebpf:"cql_events"`
...
type bpfVariableSpecs struct {
	...
	ConsistencyLevelOffsetPos *ebpf.VariableSpec `ebpf:"consistency_level_offset_pos"`
	CtxPtrOffsetPos           *ebpf.VariableSpec `ebpf:"ctx_ptr_offset_pos"`
	EndAddr                   *ebpf.VariableSpec `ebpf:"end_addr"`
	Hex                       *ebpf.VariableSpec `ebpf:"hex"`
	PageSizeOffsetPos         *ebpf.VariableSpec `ebpf:"page_size_offset_pos"`
	ShouldIncludeDbStatement  *ebpf.VariableSpec `ebpf:"should_include_db_statement"`
	StartAddr                 *ebpf.VariableSpec `ebpf:"start_addr"`
	StmtOffsetPos             *ebpf.VariableSpec `ebpf:"stmt_offset_pos"`
...
type bpfMaps struct {
	...
	CqlEvents             *ebpf.Map `ebpf:"cql_events"`
...
type bpfVariables struct {
	...
	ConsistencyLevelOffsetPos *ebpf.Variable `ebpf:"consistency_level_offset_pos"`
	CtxPtrOffsetPos           *ebpf.Variable `ebpf:"ctx_ptr_offset_pos"`
	EndAddr                   *ebpf.Variable `ebpf:"end_addr"`
	Hex                       *ebpf.Variable `ebpf:"hex"`
	PageSizeOffsetPos         *ebpf.Variable `ebpf:"page_size_offset_pos"`
	ShouldIncludeDbStatement  *ebpf.Variable `ebpf:"should_include_db_statement"`
	StartAddr                 *ebpf.Variable `ebpf:"start_addr"`
	StmtOffsetPos             *ebpf.Variable `ebpf:"stmt_offset_pos"`
...
type bpfPrograms struct {
	UprobeIter        *ebpf.Program `ebpf:"uprobe_Iter"`
	UprobeIterReturns *ebpf.Program `ebpf:"uprobe_Iter_Returns"`
}
